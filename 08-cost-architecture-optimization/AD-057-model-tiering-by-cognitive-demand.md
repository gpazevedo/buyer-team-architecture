...
> **Correction (2026-07-08):** this decision and its "Results" section describe the tier mapping as of PR #87/#88. It has since moved twice more — see the two notes appended to Results below. There was never a second, Claude-based model family in production; the "Scenario A/B" framing this ADR and AD-58 used to describe that choice has been retired — see AD-58's correction note.
